...
class DroneEnv(object):
    ...
    def compute_reward(self, drone_position, collision):
        ...
        print("reward: {:.1f}".format(float(reward)), "Loc:", end='')
